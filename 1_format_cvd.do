...
**  DO-FILE METADATA
    ...
    //  date first created      07-DEC-2022
	...
	//	note:					JC 07dec2022: upon review of ineligible cases, some eligible cases were found and entered into CVDdb 
	//							so a new db export was performed resulting in the defunct dofile '1_format_cvd_old' created on 01nov2022.
...
label define cfsource___33_ 0 "Unchecked" 1 "Checked" 
...
label define rvetype_ 1 "Stroke" 2 "Heart" 
...
label values cfsource___33 cfsource___33_
...
label variable cfsource___33 "Casefinding (CF) Source (choice=MedData)"
...
label variable rvetype "Event Type/Db Arm"
...
** Remove stroke record that accidentally entered into heart arm
** JC 27feb2023 - this was removed in 3a_clean cf_cvd.do but the collapsing of the stroke instruments for the repeating forms caused some of the data entered into record 1945 of the heart arm to overwrite data into record 1945 of the stroke arm
drop if record_id=="1945" & redcap_event_name=="heart_arm_2" //1 deleted

** The above code was generated by REDCap's export to Stata option on 07-Dec-2022 so now save this auto-formatted dataset (note: the header and paths were added post export)
