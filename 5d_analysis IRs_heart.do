...
------------+-----------------------------------
     Female |        227       48.20       48.20
       Male |        244       51.80      100.00
------------+-----------------------------------
      Total |        471      100.00
*/
...
------------+-----------------------------------
      ...
      55-59 |         35        7.43       19.53
      60-64 |         47        9.98       29.51
      65-69 |         50       10.62       40.13
      70-74 |         57       12.10       52.23
      75-79 |         45        9.55       61.78
      80-84 |         68       14.44       76.22
  85 & over |        112       23.78      100.00
------------+-----------------------------------
      Total |        471      100.00
*/
...
/*
  ...
  |-------------------------------------------------------------|
  |  471   281207   167.49     96.86    88.12   106.37     4.58 |
  +-------------------------------------------------------------+
*/
...
/*
  ...
  |-----------------------------------------------------------------------------------------------|
  | Female    227   146370   155.09     81.75    71.11    93.86     5.66   1.00        .        . |
  |   Male    244   134837   180.96    120.50   105.67   137.06     7.85   1.47     1.22     1.79 |
  +-----------------------------------------------------------------------------------------------+
*/
...
/*
  ...
  | case        N    crude   rateadj   lb_gam   ub_gam   se_gam |
  |-------------------------------------------------------------|
  |  471   281207   167.49     97.10    88.35   106.60     4.58 |
  +-------------------------------------------------------------+
*/
** JC update: Save these results as a dataset for reporting Figures 1.1 and 1.2
gen year=12
...
/*
  ...
  |    sex   case        N    crude   rateadj   lb_gam   ub_gam   se_gam    srr   lb_srr   ub_srr |
  |-----------------------------------------------------------------------------------------------|
  | Female    227   146370   155.09     82.34    71.64    94.46     5.69   1.00        .        . |
  |   Male    244   134837   180.96    120.25   105.46   136.73     7.82   1.46     1.21     1.77 |
  +-----------------------------------------------------------------------------------------------+
*/
** JC update: Save these results as a dataset for reporting Table 1.2
gen year=12
