...
putdocx save "`datapath'\version02\3-output\2020AnnualReportStatsV18_`listdate'.docx", replace
putdocx clear
...
append using "`datapath'\version02\2-working\CIRsASIRs_total_heart"
...
local listdate = string( d(`c(current_date)'), "%dCYND" )
putdocx save "`datapath'\version02\3-output\2020AnnualReportStatsV18_`listdate'.docx", append
putdocx clear
restore
...
local listdate = string( d(`c(current_date)'), "%dCYND" )
export_excel year sex number cir using "`datapath'\version02\3-output\2020AnnualReportCIR_`listdate'.xlsx", firstrow(variables) sheet(CIR_heart, replace) 

putexcel set "`datapath'\version02\3-output\2020AnnualReportCIR_`listdate'.xlsx", sheet(CIR_heart) modify
putexcel A1:D1, bold
...
append using "`datapath'\version02\2-working\ASMRs_total_heart"
...
preserve
use "`datapath'\version02\2-working\pm3_heart", clear
...
preserve
use "`datapath'\version02\2-working\pm5_asppla_heart", clear
...
local listdate = string( d(`c(current_date)'), "%dCYND" )
export_excel year sex number cir using "`datapath'\version02\3-output\2020AnnualReportCIR_`listdate'.xlsx", firstrow(variables) sheet(CIR_stroke, replace) 

putexcel set "`datapath'\version02\3-output\2020AnnualReportCIR_`listdate'.xlsx", sheet(CIR_stroke) modify
putexcel A1:D1, bold
//putexcel D2:D4, rownames nformat(number_d1) - this causes an error when opening the excel workbook so reformatted cir variable above
putexcel A1 = "Year"
putexcel B1 = "Sex"
...
preserve
use "`datapath'\version02\2-working\riskfactors_stroke", clear
...
preserve
use "`datapath'\version02\2-working\riskfactors_stroketia", clear
...
preserve
use "`datapath'\version02\2-working\mort_stroke", clear
...
preserve
use "`datapath'\version02\2-working\outcomes_stroke", clear
...
preserve
use "`datapath'\version02\2-working\pm2_stroke", clear
...
preserve
use "`datapath'\version02\2-working\pm3_stroke", clear
...
preserve
use "`datapath'\version02\2-working\pm4_stroke", clear
...
****************************************************************** Heart + Stroke ***********************************************************************************************
preserve
use "`datapath'\version02\2-working\addanalyses_ct", clear
...
preserve
use "`datapath'\version02\2-working\addanalyses_age", clear
