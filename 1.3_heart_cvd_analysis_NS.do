...
** Number of BNR Registrations by year
...
STOP
**Case Fatality Rate at 28 day (among those hospitalised)
** 79/291
tab f1vstatus year if hosp==1
tab abstracted year,miss
dis 79/291

**Case Fatality Rate at 28 day (population-based case fatality rate)
** 79/291
tab f1vstatus year
tab year,miss
dis 
...
****I do not understand the above where are tha additional 6 cases coming from?

***Also, see alternative codes below to provide Inhospital CFR
tab vstatus abstracted if hosp==1 & abstracted==1 & year==2020  ,m col
by year,sort:tab vstatus abstracted if hosp==1 & abstracted==1, m col


****For Hospitalised cases
by year,sort:tab vstatus abstracted if hosp==1,m col


***Alternative code for CFR at 28 days
by year,sort:tab f1vstatus abstracted if hosp==1 & abstracted==1 ,m col
***CFR regardless of whether abstracted or not
by year,sort:tab f1vstatus abstracted if hosp==1 ,m col
...
tab aspach aspacs if year==2020 & abstracted == 1, miss
...
***Alternative code for PM1
tab aspach aspacs if year==2020 & abstracted == 1, miss row col
...
preserve
tab reperf ecgste if year==2020, m row
...
***Alternative code for reperfusions by sex and year
