...
** SW:  The variable sex is currently coded as  Females: 1 and Males: 2. This is different to the mortaility datasets were Males: 1 and Females: 2. Therefore, in order to ensure that the sex variable is aligned with the other datasets, this needs to be adjusted.

// Flipping codes for the variable sex.
gen sex2=.
replace sex2=1 if sex==2
replace sex2=2 if sex==1
label define sex_new 1 "Male" 2 "Female"
label values sex2 sex_new
order sex2 sex
drop sex
rename sex2 sex
...
------------+-----------------------------------
       Male |        245       52.46       52.46
     Female |        222       47.54      100.00
------------+-----------------------------------
      Total |        467      100.00
