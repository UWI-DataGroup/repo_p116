...
save "`datapath'\version02\2-working\CIRsASIRs_total_heart" ,replace
...
sort age_10
save "`datapath'\version02\2-working\tempdistrate_mort_heart" ,replace
...
save "`datapath'\version02\2-working\ASMRs_total_heart" ,replace
...
** Using WHO World Standard Population
*****************************************************
use "`datapath'\version02\2-working\tempdistrate_mort_heart" ,clear
...
save "`datapath'\version02\2-working\ASMRs_heart" ,replace
** Remove the temp database created above to reduce space used on SharePoint
erase "`datapath'\version02\2-working\tempdistrate_mort_heart.dta"
restore
*****
