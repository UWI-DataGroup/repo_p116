...
------------+-----------------------------------
     Female |        331       47.90       47.90
       Male |        360       52.10      100.00
------------+-----------------------------------
      Total |        691      100.00
*/
...
------------+-----------------------------------
      ...
      55-59 |         62        8.97       20.12
      60-64 |         67        9.70       29.81
      65-69 |         83       12.01       41.82
      70-74 |         84       12.16       53.98
      75-79 |         78       11.29       65.27
      80-84 |         82       11.87       77.13
  85 & over |        158       22.87      100.00
------------+-----------------------------------
      Total |        691      100.00
*/
...
/*
  ...
  |-------------------------------------------------------------|
  |  691   281207   245.73    142.71   132.01   154.19     5.58 |
  +-------------------------------------------------------------+
*/
...
/*
  ...
  |-----------------------------------------------------------------------------------------------|
  | Female    331   146370   226.14    119.35   106.31   133.86     6.88   1.00        .        . |
  |   Male    360   134837   266.99    175.53   157.61   195.17     9.42   1.47     1.25     1.72 |
  +-----------------------------------------------------------------------------------------------+
*/
...
------------+-----------------------------------
      ...
      35-44 |         25        3.62        4.49
      45-54 |         46        6.66       11.14
      55-64 |        129       18.67       29.81
      65-74 |        167       24.17       53.98
      75-84 |        160       23.15       77.13
  85 & over |        158       22.87      100.00
------------+-----------------------------------
      Total |        691      100.00
*/
...
/*
  ...
  | case        N    crude   rateadj   lb_gam   ub_gam   se_gam |
  |-------------------------------------------------------------|
  |  691   281207   245.73    142.99   132.27   154.47     5.59 |
  +-------------------------------------------------------------+
*/
** JC update: Save these results as a dataset for reporting Figures 1.1 and 1.2
gen year=12
...
/*
  ...
  |    sex   case        N    crude   rateadj   lb_gam   ub_gam   se_gam    srr   lb_srr   ub_srr |
  |-----------------------------------------------------------------------------------------------|
  | Female    331   146370   226.14    119.87   106.78   134.36     6.90   1.00        .        . |
  |   Male    360   134837   266.99    175.49   157.57   195.08     9.41   1.46     1.25     1.71 |
  +-----------------------------------------------------------------------------------------------+
*/
** JC update: Save these results as a dataset for reporting Table 1.2
gen year=12
